...
CREATE TABLE IF NOT EXISTS `mydb1`.`user` (
  ...
  `DescriptionProfile` VARCHAR(150) NOT NULL DEFAULT 'Description',
  ...
  `Nazionalita` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`idUser`),
...
CREATE TABLE IF NOT EXISTS `mydb1`.`messaggio` (
  ...
  `Testo` MEDIUMTEXT NULL DEFAULT NULL,
  `data` DATETIME NOT NULL,
  `NomeViaggio` VARCHAR(30) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb1`.`step` (
  ...
  `PrecisionInformation` VARCHAR(500) NULL DEFAULT 'informazioni piu precise',
