        ...
        <div class="panel">
            ...
            <form id="add-travel" class="add-travel">
                ...
                <div class="line">
                    ...
                    <input type="date", name="s-date", class="date-picker", value="start">
                    <input type="date", name="e-date", class="date-picker", value="end">
                </div>
                <div class="line">
                    <p class="text">
                        Add a description:
                ...
                <div class="line">   
                    ...
                    <input type="button", name="choose", class="add-button", value="choose">
                </div>    
        ...
        <div class="panel">
            <form id="add-step", class="add-travel">
                ...
                <div class="line">  
                    ...
                    <a href="../Travelbook/src/main/java/travelbook/view/mapView.html" class="vom">View on maps</a>
                ...
                <div class="line">    
                    ...
                    <input type="button", name="remove", class="icon-button">
                    <input type="button", name="add", class="icon-button">
                </div>
                <div class="line">  
                    <p class="text">
                        Add a description:
                    </p>
                    <textarea class="add-text area", id="step-descr", wrap="hard"></textarea>
                </div>
                <div class="line">   
                    <p class="text">
                        Do you want to give some pratical information?
                    </p>
                    <textarea class="add-text area", id="step-inf", wrap="hard"></textarea>
                </div>
                <div class="line"> 
                    <p class="text">
                        Upload some photos:
                    </p>
                    <input type="button", name="img-choose", class="add-button", value="choose">
                    <progress>0%</progress>
                </div>
                <div class="photo-grid">
                <img href="">
